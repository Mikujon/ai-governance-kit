...
2. Modifica i file necessari. Se cambi un requisito nella matrice (`AI_PROJECT_GUIDELINES.md` o `AI_PROJECT_STRUCTURE.md`), aggiorna anche lo starter (`PROJECT_STARTER_T*.md`) corrispondente — devono restare coerenti tra loro.
