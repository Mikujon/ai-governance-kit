...
```bash
git clone --branch v1.6.0 https://github.com/wearefiber/ai-governance-kit.git
```

Or fetch a single file without cloning (useful inside a prompt):

```
https://raw.githubusercontent.com/wearefiber/ai-governance-kit/v1.6.0/AI_INTAKE_ASSESSMENT.md
```
