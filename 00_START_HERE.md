...
| `AI_TECHNICAL_DEPTH_REVIEW.md` | Companion to the audit above, mandatory once a tool is confirmed Tier 3: a line-by-line technical read — queries, caching, API maturity, scalability — that the governance audit deliberately doesn't do. |
