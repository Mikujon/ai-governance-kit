...
| `PROCESS_FLOW.md` | L'intero kit in cinque diagrammi di flusso: intake, gate di build per tier, il modello di ownership sopra il Tier 0, il ciclo di revisione/passaggio dopo il go-live, e il percorso di escalation della governance. |
