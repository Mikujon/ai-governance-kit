...
```bash
git clone --branch v1.5.0 https://github.com/wearefiber/ai-governance-kit.git
```

Oppure, per leggere un solo file senza clonare (es. dentro un prompt):

```
https://raw.githubusercontent.com/wearefiber/ai-governance-kit/v1.5.0/AI_INTAKE_ASSESSMENT.md
```
